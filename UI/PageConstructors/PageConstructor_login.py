...
def constructor(ui_core, ttc:TooltipController, cache, page_data):
    ...
    def attempt_login():
        ...
        if login_success:
            ...
            invalid_login.configure(text="Invalid login. Please try again.")
    ...
    invalid_login = ttk.Label(entry_frame, text = "", foreground="red", font=("Arial", 12))
    ...
    invalid_login.pack(expand=TRUE)
